...
def move_robot(linear_velocity_x, linear_velocity_y, linear_velocity_z, angular_velocity_roll, angular_velocity_pitch, angular_velocity_yaw):
    ...
    velocity_command.linear.z = linear_velocity_z
    velocity_command.angular.x = angular_velocity_roll
    velocity_command.angular.y = angular_velocity_pitch
