...
class PathPlanner:
    def __init__(self):
        ...
        self.grid_pub = rospy.Publisher('/visualized_grid', OccupancyGrid, queue_size=10)
        ...
        # Parameters
        self.safety_margin = 0.5  # Safety margin in meters
    ...
    def dilate_obstacles(self, grid, margin):
        from scipy.ndimage import distance_transform_edt
        distance = distance_transform_edt(grid == 0)
        return (distance <= margin).astype(int)
    ...
    def publish_grid(self, grid):
        ...
        occupancy_grid.info = self.map_data.info
    ...
    def plan_path(self):
        ...
        grid = self.dilate_obstacles(grid, margin_cells)
